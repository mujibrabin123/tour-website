...
<head>
    ...
    <title>welcome to the Rabin tour agency </title>


<!--taken from swipper site-->
...
<div class="login-form-container">
    ...
    <form action="login.php" method="POST">
        ...
        <input type="password" class="box" placeholder="enter your password" name="password"> <!-- Added name attribute -->
        <input type="submit" value="login now" class="btn">
        <input type="checkbox" id="remember">
        <label for="remember">remember me</label>
        <p>forget password? <a href="forgotpass.html">click here</a></p>
        <p>dont have an account? <a href="regitrations.php">register now</a></p> 
    </form>
</div>
    ...
    <div class="box-container">
        <div class="box">
            ...
            <div class="content">
                ...
                <a href="https://stock.adobe.com/it/search?k=sicily" class="btn">see more</a>
            </div>
        </div>
